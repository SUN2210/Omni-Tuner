...
CONFIG_FILE="Omni_Tuner_configs/swin-l_dota3c_fs/dota3c_fs_retinanet_swin_large_5x_${METHOD}.py"
PRETRAINED_PATH="work_dirs/xview3c_retinanet_swin_large_1x_${METHOD}/best.pth"
STYLE_STATS_PATH="work_dirs/xview3c_retinanet_swin_large_1x_${METHOD}/style_stats_patch_stage0123_prepost.pth"
