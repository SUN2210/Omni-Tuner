...
STYLE_MIX_ALPHA="x"
STYLE_MIX_ALPHA_INIT="0.01"
STYLE_MIX_ALPHA_SCOPE="shared"
MIX_ALPHA_LR_MULT="200"
STYLE_PROPAGATION="full"

CONFIG_FILE="Omni_Tuner_configs/swin-l_ssdd1c_fs/ssdd1c_fs_retinanet_swin_large_5x_${METHOD}.py"
PRETRAINED_PATH="work_dirs/hrrsd1c_retinanet_swin_large_1x_${METHOD}/best.pth"
STYLE_STATS_PATH="work_dirs/hrrsd1c_retinanet_swin_large_1x_${METHOD}/style_stats_patch_stage0123_prepost.pth"
