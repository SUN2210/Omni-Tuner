...
CONFIG="${PROJECT_ROOT}/Omni_Tuner_configs/swin-l_hrrsd1c/hrrsd1c_retinanet_swin_large_1x_${METHOD}.py"
WORK_DIR="${PROJECT_ROOT}/work_dirs/hrrsd1c_retinanet_swin_large_1x_${METHOD}"
...
SCREEN_OUT="${WORK_DIR}/hrrsd1c_prototypes_screen.pth"
SCREEN_TOKENS="${WORK_DIR}/hrrsd1c_tokens_screen.pth"
FREQ_OUT="${WORK_DIR}/hrrsd1c_prototypes_backbone_frequency.pth"
FREQ_TOKENS="${WORK_DIR}/hrrsd1c_tokens_backbone_frequency.pth"
GLOBAL_OUT="${WORK_DIR}/hrrsd1c_prototypes_global.pth"
GLOBAL_TOKENS="${WORK_DIR}/hrrsd1c_tokens_global.pth"
